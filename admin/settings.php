                        ...
                        <div class="card custom-card-2 mt-2">
                            <div class="card-body p-4">
                                <form method="post" action="assets/functions/functions.php" enctype="multipart/form-data">                  
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="title">Phone Number1 :</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="title">Phone Number2 :</label>
                                    ...
                                    <div class="d-flex justify-content-right mt-4">                                   
                                        <button type="submit" class="btn submit_btn btn-sm float-end submit_btn me-1" name="update_settings" style="background-color: #0d4c91;">UPDATE</button>
