                    ...
                    <div class="card-body p-4">
                        <form method="post" action="assets/functions/functions.php" enctype="multipart/form-data">  
                                ...
                                <select class="form-select"  name="category_name" aria-label="Default select example">
                                    ...
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_array($run)){
                                            ...
                                            $category_name = $row["category_name"];                                                                                           
                                    ?>
                                    <option value=""><?php echo $category_name?></option>
                                    <?php } ?>                               
                                </select>
                            </div>        
                            ...
                            <div class="mb-3">
                                ...
                                <button type="submit" class="btn submit_btn float-end" name="update_products" style="background-color:0d4c91;">SUBMIT</button>
                            </div>
                        </form>
                    </div>
                </div>            
