                    ...
                    <div class="card-body p-4">
                        <form method="post" action="assets/functions/functions.php" enctype="multipart/form-data">  
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="designation" id="designation" value="<?php echo $name ?>" placeholder="Enter the Name" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-sm submit_btn float-end" name="update_testimonial" style="background-color:0d4c91;">SUBMIT</button>
                            </div>
                        </form>
                    </div>
                </div>            
